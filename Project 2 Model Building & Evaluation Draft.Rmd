...
set.seed(5000)
sample <- sample(c(TRUE, FALSE), nrow(diabetes50), replace = TRUE, prob=c(0.8,0.2))
...
```{r}
tree_pred <- predict(tree1, newdata=data_test, type = "class")
cm3 <- confusionMatrix(tree_pred, data_test$diabetes)
